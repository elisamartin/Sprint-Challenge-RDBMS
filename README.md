...
RDBMS is a type of database management systems (relational database management system), while SQL is a language for interacting with the data stored in the database management system.

1. Why do tables need a `primary key`?

So that each entry can be uniquely identified for later manipulations
...
We need a JOIN clause in order to relate two tables with a 'many to many' relationship
